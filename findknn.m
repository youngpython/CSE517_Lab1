...
% alldists is nxm, n is xTr rows, m is xTe cols
% sort distances in ascending order in each column
% sorting by nearest neighbor of each xTe vec (in cols) in all of the 
% xTr vectors
